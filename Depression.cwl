...
steps:
  ...
  schizoaffective-depression---primary:
    run: schizoaffective-depression---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  atypical-depression---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: schizoaffective-depression---primary/output
  ...
  depression-manicdepress---primary:
    run: depression-manicdepress---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  other-depression---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-manicdepress---primary/output
  ...
  depression-history---primary:
    run: depression-history---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  depression---secondary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: depression-history---primary/output
  output-cases:
